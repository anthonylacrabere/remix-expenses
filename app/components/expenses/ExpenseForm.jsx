import { Link,Form, useActionData, useSubmit, useParams, useMatches, useLoaderData, useNavigation } from "@remix-run/react"
...
function ExpenseForm() {
  ...
  // const expenseData = useLoaderData() // undefined in the case of create expense 
  ...
  //   // perform your own client side validation
  //   // then submit the form like remix want 
  //   submit(event.target, {
  //     // action: "/expenses/add"
  //     // method: "post"
  //   })
